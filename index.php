    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          ...
          <img src="assets/img/cachorro1.webp" class="d-block imagemdog" alt="..." style="height: 250px">
        </div>
        <div class="carousel-item">
          <div class="quadrado"></div>
          <img src="assets/img/cachorro2.webp" class="d-block imagemdog" alt="..." style="height: 250px">
        </div>
        <div class="carousel-item">
          <div class="quadrado"></div>
          <img src="assets/img/cachorro3.webp" class="d-block imagemdog" alt="..." style="height: 250px">
        </div>
      </div>
